              ...
              <Col md="6" lg="5">
                <ProjectCard>
                  <div className="project-head">
                    ...
                    >
                      <UserAvatar className="sq" theme="primary" text={findUpper("IDRT Dev")} />
                      <div className="project-info">
                        <h6 className="title">IDRT Development</h6>
                  ...
                  <div className="project-details">
                    Design and develop the IDRT template for Envato Marketplace.
                  </div>
