                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <textarea
                            ...
                            id="review"
                            defaultValue="I've been using IDRT for months now and with every update, it's just becoming better.
                ...
                <Card className="mt-4">
                  ...
                  <div className="card-inner">
                    <p className="text-soft">
                      I've been using IDRT for months now and with every update, update it's just becoming more and
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  You can use customize <code>Rating</code> component used in react IDRT.
                </p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
