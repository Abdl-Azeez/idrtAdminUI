          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                for further understanding. The plugin has been customized for the purpose of React IDRT.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Just import <code>ReactDataTable</code> from <code>components</code>, it is built in for react IDRT.
              </p>
            </BlockHeadContent>
          </BlockHead>
