  ...
  datasets: [
    {
      ...
      pointHitRadius: 4,
      data: [
        7910, 6420, 4910, 5780, 11400, 5170, 6460, 8830, 5290, 10430, 9690, 8350, 4600, 5200, 10650, 6850, 6950, 5150,
        9300, 6000, 6800, 11950, 6900, 7950, 9900, 4200, 6250, 10650, 8950, 9750,
      ],
    },
    {
      label: "TOTAL OUT",
      ...
      pointHitRadius: 4,
      data: [
        4110, 4220, 4810, 5480, 4600, 5670, 6660, 10830, 5590, 11730, 9790, 4950, 8100, 5800, 9950, 8850, 5950, 7450,
        10900, 8000, 7200, 7250, 7900, 8950, 6300, 7200, 7250, 7650, 6950, 4750,
      ],
    },
  ],
};
...
export const topWalletsData = [
  {
    id: 1,
    channel: "Oxb218C5D6aF1F979aC42BC68d98A5A0D796C6aB01",
    sessions: "400,0000",
    prev: "(USD$XX)",
    change: "3.29",
    changeDifference: "up",
