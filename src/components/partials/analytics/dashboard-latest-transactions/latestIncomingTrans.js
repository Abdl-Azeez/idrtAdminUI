                ...
                {transactions?.latestIncomingTransactions?.length > 0 ?
                  <div className="nk-tb-list is-loose traffic-channel-table">
                    <DataTableHead className="">
                      ...
                      <DataTableRow className="nk-tb-sessions font-weight-bolder text-dark">Date/Time</DataTableRow>
                        ...
                        return (
                          <DataTableItem className="nk-tb-item L" key={item.txnHash}>
                            ...
                            <DataTableRow className="nk-tb-prev-sessions">
                              <div className="text-truncate text-info" style={{ maxWidth: '150px' }}>{item.txnHash}</div>
                            </DataTableRow>
                            <DataTableRow className="nk-tb-prev-sessions">
                              <div className="text-truncate text-info" style={{ maxWidth: '150px' }} >{item.fromAddress}</div>
                            </DataTableRow>
                            <DataTableRow className="nk-tb-prev-sessions">
                              <div className="text-truncate text-info" style={{ maxWidth: '150px' }}>{item.walletId} </div>
                            </DataTableRow>
                            <DataTableRow className="nk-tb-prev-sessions">
