    ...
    return (
        <React.Fragment>
            <div className="pl-3 mr-auto w-75 d-flex flex-column justify-content-center" style={{ gap: '10px' }} md={12}>
                ...
                <Row className="d-flex justify-content-between" style={`${role === "AGENT" && { flexFlow: 'row-reverse' }}`}>
                    ...
                    <Card className="text-center px-3 py-4 justify-content-center align-items-center shadow mt-0" style={{ width: '220px' }}>
                        ...
                        <h5 className="w-80 text-dark">1,234</h5>
                    </Card>

                    {role === "AGENT" ?
                        <Card className="text-center px-3 py-4 justify-content-center align-items-center shadow mt-0" style={{ width: '220px' }}>
                            <p style={{ fontSize: '20px' }}>Total # of Merchants</p>
                            <h5 className="w-80 text-dark">10</h5>
                        </Card>
                        :
                        <Card className="text-center px-3 py-4 justify-content-center align-items-center shadow mt-0" style={{ width: '220px' }}>
